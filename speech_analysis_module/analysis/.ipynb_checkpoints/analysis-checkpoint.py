...
#envelope
def envelope(raw, sr, backtrack=True, plot=False, show_onsets=True, delta=0):
...
#get STFT and psd
def psd(raw, sr, n_fft=2048, plot=False):
...
def welch(raw, sr, n_fft=2048, db=False, plot=False):
